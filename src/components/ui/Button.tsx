  ...
  return (
    <button
      className={cn(
        ...
        {
          'bg-accent text-white hover:bg-accent-hover active:scale-[0.98] focus-visible:ring-accent': variant === 'primary',
          'bg-surface-1 text-text-primary hover:bg-surface-2 border border-border focus-visible:ring-border': variant === 'secondary',
          'text-text-secondary hover:text-text-primary hover:bg-surface-2 focus-visible:ring-border': variant === 'ghost',
          'bg-red-600 text-white hover:bg-red-700 active:scale-[0.98] focus-visible:ring-red-500': variant === 'danger',
        },
        {

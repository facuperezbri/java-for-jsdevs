      ...
      concepts: [
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// Express.js REST API
...
app.listen(3000, () => {
  console.log('Server running on port 3000');
            ...
            right: { label: 'Java', language: 'java', code: `// Spring Boot REST API
@RestController
...
// the server, port 8080, JSON serialization, etc.` },
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// TypeScript decorators (similar concept)
@Controller()
class UserController {
  ...
  findAll() {
    return users;
            ...
            right: { label: 'Java', language: 'java', code: `// Spring Boot annotations
    ...
    <plugins>
      <plugin>spring-boot-maven-plugin</plugin>
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `# npm commands
npm install          # install dependencies
npm run start        # run the app
npm test             # run tests
npm run build        # build for production` },
            right: { label: 'Java', language: 'java', code: `# Maven commands
...
./mvnw package` },
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `# Node.js project (flexible)
my-app/
├── src/             # your code
├── test/            # tests
...
└── dist/            # build output` },
            right: { label: 'Java', language: 'java', code: `# Maven/Spring Boot project (standardized)
my-app/
├── src/
│   ├── main/
...
app.post('/users', (req, res) => {
  ...
  res.status(201).json(user);
            ...
            right: { label: 'Java', language: 'java', code: `// Spring Boot Controller
@RestController
  ...
  public User createUser(@RequestBody User user) {
    return saveUser(user);  // @RequestBody = req.body
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// Express: fine-grained response control
app.get('/users/:id', (req, res) => {
      ...
      concepts: [
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// React Context as DI analogy
...
function UserList() {
  ...
  return userService.getAll().map(...);
            ...
            right: { label: 'Java', language: 'java', code: `// Spring Dependency Injection
  ...
  public OrderService(___BLANK_3___ repository) {
    this.repository = repository;
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS: no formal layer distinction
...
class UserRepository {  // another class
  query(sql) { ... }
            ...
            right: { label: 'Java', language: 'java', code: `@Repository  // data access layer
      ...
      concepts: [
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// Prisma schema (JS ORM equivalent)
model User {
...
const user = await prisma.user.findUnique({
  where: { id: 1 }
            ...
            right: { label: 'Java', language: 'java', code: `// Spring Data JPA Entity
@Entity
@Table(name = "users")
public class User {
  @Id
  ...
  // getters and setters...
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// Prisma: CRUD operations
...
await prisma.user.findMany({
  where: { name: { startsWith: 'A' } }
            ...
            right: { label: 'Java', language: 'java', code: `// JpaRepository: extend to get CRUD free
      ...
      concepts: [
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// Jest test
...
test('throws on invalid input', () => {
  expect(() => add(null, 3)).toThrow();
            ...
            right: { label: 'Java', language: 'java', code: `// JUnit 5 test
  ...
  void testMultiply() {
    ...
    ___BLANK_2___(12, calc.multiply(3, 4));
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// Jest lifecycle
let calculator;
...
test('adds numbers', () => {
  expect(calculator.add(1, 2)).toBe(3);
            ...
            right: { label: 'Java', language: 'java', code: `// JUnit 5 lifecycle
  ...
  void addsNumbers() {
    assertEquals(3, calculator.add(1, 2));
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// Jest mocking
const userRepo = {
...
expect(userRepo.findById).toHaveBeenCalledWith(1);` },
            right: { label: 'Java', language: 'java', code: `// Mockito mocking

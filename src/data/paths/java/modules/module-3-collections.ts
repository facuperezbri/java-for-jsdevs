      ...
      concepts: [
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS array \u2014 dynamic by default
const fruits = [];
fruits.push("apple");
fruits.push("banana");
...
console.log(fruits);        // ["banana"]` },
            right: { label: 'Java', language: 'java', code: `// Java ArrayList \u2014 dynamic array
      ...
      concepts: [
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS plain object
const scores = {};
scores["Alice"] = 95;
scores["Bob"] = 87;
      ...
      concepts: [
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS Set
const seen = new Set();
seen.add("apple");
seen.add("banana");
      ...
      concepts: [
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// TypeScript bounded generics
...
function getLength<T extends { length: number }>(item: T) {
  return item.length;
            ...
            right: { label: 'Java', language: 'java', code: `// Java bounded generics
...
// sum(List.of("a", "b"));    // compile error!` },
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// TypeScript: types are compile-time only
// At runtime, this is just a regular array
const nums: Array<number> = [1, 2, 3];` },
            right: { label: 'Java', language: 'java', code: `// Java type erasure: at runtime, generics become Object
      ...
      concepts: [
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS array methods

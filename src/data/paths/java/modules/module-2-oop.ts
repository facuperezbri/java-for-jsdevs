      ...
      concepts: [
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS class
class Person {
...
const alice = new Person("Alice", 30);` },
            right: { label: 'Java', language: 'java', code: `// Java class (must be in Person.java)
public class Person {
  ...
  public Car(String make, int year) {
    ...
    this.year = year;
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS: put anything in any file
// utils.js can export multiple classes
export class Dog { ... }
export class Cat { ... }
export class Animal { ... }` },
            right: { label: 'Java', language: 'java', code: `// Java: one public class per file
// File: Dog.java
public class Dog { ... }
      ...
      concepts: [
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// Modern JS private fields
class BankAccount {
  #balance = 0; // private
  ...
  getBalance() {
    return this.#balance;
            ...
            right: { label: 'Java', language: 'java', code: `// Java access modifiers
  ...
  public double getBalance() {
    return balance;
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS getters/setters
class Person {
  #name;
  ...
  set name(val) {
    if (val.length > 0) this.#name = val;
            ...
            right: { label: 'Java', language: 'java', code: `// Java getters and setters (convention)
public class Person {
  private String name;
  ...
  public String speak() {
    return name + " meows!";
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS: silent override, no warning
class Dog extends Animal {
...
d.speak(); // calls Animal.speak(), not Dog.speek()!` },
            right: { label: 'Java', language: 'java', code: `// Java: @Override catches mistakes
class Dog extends Animal {
  @Override
      ...
      concepts: [
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// TypeScript interface (pure contract)
interface Drawable {
  draw(): void;
  getColor(): string;
}
...
class Circle implements Drawable {
  ...
  getColor() { return "red"; }
            ...
            right: { label: 'Java', language: 'java', code: `// Java interface
...
public class Circle implements Drawable {
  ...
  public String getColor() { return "red"; }
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS doesn't have abstract classes natively
...
class Shape {
  ...
  describe() {
    return \`Area: \${this.area()}\`;
            ...
            right: { label: 'Java', language: 'java', code: `// Java abstract class
      ...
      concepts: [
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// TypeScript generics
...
const str = firstItem(["a", "b"]);    // string` },
            right: { label: 'Java', language: 'java', code: `// Java generics
...
String str = firstItem(new String[]{"a", "b"});` },
  ...
  public T ___BLANK_3___() { return first; }
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// TypeScript generic class
class Box<T> {
  private value: T;
...
const strBox = new Box<string>("hello");` },
            right: { label: 'Java', language: 'java', code: `// Java generic class
public class Box<T> {
  private T value;
...
Integer n = numBox.getValue(); // type-safe!` },
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// TypeScript: simple data type
...
class Point {
  constructor(public x: number, public y: number) {}
            ...
            right: { label: 'Java', language: 'java', code: `// Java record — one line!
      ...
      concepts: [
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// TypeScript: union type or const object
...
let c: Color = "RED";
// c = "PURPLE"; // TS error` },
            right: { label: 'Java', language: 'java', code: `// Java enum
enum Color {
  RED, GREEN, BLUE
}
...
Size mySize = ___BLANK_3___;`,
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// TypeScript: enum-like with data
const HttpStatus = {
...
console.log(HttpStatus.OK.code); // 200` },
            right: { label: 'Java', language: 'java', code: `// Java enum with fields and methods
enum HttpStatus {
  OK(200, "OK"),
...
System.out.println(HttpStatus.NOT_FOUND.getMessage()); // Not Found` },
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// TypeScript exhaustive switch

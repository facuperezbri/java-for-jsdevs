      ...
      concepts: [
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS: type is inferred, can change
let age = 30;
...
let isActive = true;
let price = 9.99;` },
            right: { label: 'Java', language: 'java', code: `// Java: type must be declared explicitly
int age = 30;
...
___BLANK_3___ isActive = true;`,
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS has just Number, String, Boolean
const count = 42;          // Number
const pi = 3.14;           // Number
const letter = 'A';        // String (of length 1)
const flag = true;         // Boolean` },
            right: { label: 'Java', language: 'java', code: `// Java has distinct numeric types
...
___BLANK_3___ bigNumber = 9999999999L;`,
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS: var/let/const with runtime type
let message = "Hello";
message = 42; // fine, types are dynamic` },
            right: { label: 'Java', language: 'java', code: `// Java var: type inferred at compile time
...
// var still = static type, just written less` },
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS: const prevents reassignment
const MAX = 100;
// MAX = 200; // TypeError!

const user = { name: "Alice" };
user.name = "Bob"; // allowed! const ≠ immutable` },
            right: { label: 'Java', language: 'java', code: `// Java: final prevents reassignment
final int MAX = 100;
      ...
      concepts: [
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS: functions can be standalone
function greet(name) {
  return "Hello, " + name + "!";
}
...
console.log(greet("Alice")); // Hello, Alice!` },
            right: { label: 'Java', language: 'java', code: `// Java: methods must be inside a class
public class Greeter {
  ...
  return a + b;
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS: return type is implicit/flexible
function add(a, b) {
...
function logMessage(msg) {
  ...
  // implicitly returns undefined
            ...
            right: { label: 'Java', language: 'java', code: `// Java: return type is explicit
int add(int a, int b) {
...
void logMessage(String msg) {
  ...
  // void = no return value
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS: one function, handle variations inside
...
greet("Bob", "Hi");       // Hi, Bob!` },
            right: { label: 'Java', language: 'java', code: `// Java: separate methods with same name
...
greet("Bob", "Hi");       // Hi, Bob!` },
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS: module functions vs instance methods
...
calc.add(1, 2);       // called on instance` },
            right: { label: 'Java', language: 'java', code: `// Java: static vs instance
...
String result = ___BLANK_1___.___BLANK_2___("hello");`,
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS: ES modules
...
import axios from 'axios'; // from node_modules` },
            right: { label: 'Java', language: 'java', code: `// Java: packages & imports
      ...
      concepts: [
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS: truthy/falsy coercion
...
while (i < 5) {
  console.log(i++);
            ...
            right: { label: 'Java', language: 'java', code: `// Java: must be explicit boolean
...
while (i < 5) {
  System.out.println(i++);
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS: == and === compare values
const a = "hello";
const b = "hello";
console.log(a === b); // true (same value)
console.log(a == b);  // true (same value)` },
            right: { label: 'Java', language: 'java', code: `// Java: == checks REFERENCE, not value
String a = "hello";
...
// string pool optimization, but don't rely on it!` },
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS: for...of loop
const fruits = ["apple", "banana", "cherry"];
for (const fruit of fruits) {
  console.log(fruit);
}` },
            right: { label: 'Java', language: 'java', code: `// Java: enhanced for loop
...
switch (day) {
  ...
  default:
    console.log("Other day");
            ...
            right: { label: 'Java', language: 'java', code: `// Java classic switch (same as JS)
switch (day) {
  case "MON":
  case "TUE":
...
String result = switch (day) {
  ...
  default -> "Other day";
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS String methods
...
\`Hello \${name}\`          // template literal` },
            right: { label: 'Java', language: 'java', code: `// Java String methods
      ...
      concepts: [
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS arrays are dynamic
const nums = [1, 2, 3];
nums.push(4);        // easy!
nums.push(5, 6);     // also fine
console.log(nums.length); // 6` },
            right: { label: 'Java', language: 'java', code: `// Java arrays have fixed size
int[] nums = {1, 2, 3};
...
System.out.println(names[___BLANK_2___]);`,
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS arrays
...
names.forEach(name => {
  console.log(name);
            ...
            right: { label: 'Java', language: 'java', code: `// Java arrays
      ...
      concepts: [
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS: both null and undefined
let x;           // undefined
let y = null;    // null
...
console.log(y?.name);    // undefined (safe)` },
            right: { label: 'Java', language: 'java', code: `// Java: only null, no undefined
String name = null;
...
if (name != null) {
  System.out.println(name.length());
        ...
        },
        {
          ...
          codeExample: {
            left: { label: 'JavaScript', language: 'javascript', code: `// JS/TS: optional values
...
try {
  ...
  console.log("Always runs");
            ...
            right: { label: 'Java', language: 'java', code: `// Java: try/catch with typed exceptions
try {

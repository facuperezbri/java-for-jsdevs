...
./mvnw package`,
        ...
        },
        {
          ...
          codeExample: {
            javascript: `# Proyecto Node.js (flexible)
my-app/
├── src/             # tu código
├── test/            # tests
...
└── dist/            # salida de build`,
            java: `# Proyecto Maven/Spring Boot (estandarizado)
my-app/
├── src/
│   ├── main/
